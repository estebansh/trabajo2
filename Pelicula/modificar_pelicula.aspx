<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="modificar_pelicula.aspx.cs" Inherits="Pelicula_modificar_pelicula" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_descripcion" ErrorMessage="INGRESE DESCRIPCION"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">Año de estreno:</td>
                <td>
                    <asp:TextBox ID="txt_año" runat="server" TextMode="Number"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_año" ErrorMessage="INGRESE AÑO"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sakilaConnectionString %>" SelectCommand="SELECT [name], [language_id] FROM [language]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">Duracion de la renta:</td>
                <td>
                    <asp:TextBox ID="txt_renta" runat="server" TextMode="Number"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_renta" ErrorMessage="SOLO NUMEROS"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_rating" ErrorMessage="SOLO NUMEROS"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_duracion" ErrorMessage="SOLO NUMEROS"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_costo" ErrorMessage="SOLO NUMEROS"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
